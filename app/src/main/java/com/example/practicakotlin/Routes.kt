...
sealed class Routes(val route: String) {
    ...
    object Pantalla4 : Routes("pantalla4/{intentos}/{dificultad}/{palabra}") {
        fun createRoute(intentos: Int, dificultad: String, palabra: String) = "pantalla4/$intentos/$dificultad/$palabra"
    }
}