...
sealed class Routes(val route: String) {
    ...
    object Pantalla4 : Routes("pantalla4/{intentos}/{haGanado}/{dificultad}") {
        fun createRoute(intentos: Int, haGanado: Boolean, dificultad: String) = "pantalla4/$intentos/$haGanado/$dificultad"
    }
}